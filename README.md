...
- [Sublime Text 使用笔记](/softwares/sublimetext/sublime.md)
...
- [Gridea](/blog/Gridea/Gridea.md)
- [博客Mysql代码](/blog/mysql.md)
- [301的几种实现方式](/blog/html-css/301.md)
- [Copyleft 符号](/blog/html-css/copyleft.md)
- [文件列表索引.md](/blog/文件列表索引.md)

## python
- [Python学习笔记](/python/python.md)
    - [Python3学习笔记1](/python/Python3Notes1.md)
    - [Python3学习笔记2](/python/Python3Notes2.md)
- [Awesome Python Books](/python/books.md)
- [Python爬虫笔记](/python/python爬虫.md)
- [机器学习科普书单](/python/机器学习科普书单.md)
- [嵌入式 Python](/python/嵌入式Python.md)


## Windows
- [mklink同步本地文件夹](/windows/mklink.md)
- [右键新建菜单中添加 Md文件类型](/windows/new-md-file.md)
- [自用hosts](/windows/hosts)
- [利用 Openshift SSH 代理](/windows/openshift-ssh.md)
